...
export default function Hero() {
  ...
  // Fallback values
  const title = hero?.title || "Best IVF Center & Super Specialty Hospital in Bilaspur";
  const description = hero?.description || "Where Advanced Fertility Science Meets Compassionate Care. From IVF & Gynecology To Plastic Surgery, Hair Transplant, Cardiology — Experience World-Class Healthcare With Proven Results At Bilaspur's Premier Hospital.";
  const backgroundImage = hero?.backgroundImage || "/images/hero-img.svg";
  const ctaButtonText = hero?.ctaButtonText || "Book an Appointment";
