...
const adminMenuItems = [
  ...
  { href: "/admin/facilities", label: "Facilities", icon: "fi-sr-building" },
  { href: "/admin/facilities/new", label: "Create Facility", icon: "fi-sr-plus" },
  { href: "/admin/gallery", label: "Gallery", icon: "fi-sr-images" },
  { href: "/admin/gallery/new", label: "Add Gallery Item", icon: "fi-sr-plus" },
