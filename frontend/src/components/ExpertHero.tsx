export default function ExpertHero() {
  return (
    <section className="relative min-h-80 overflow-hidden sm:min-h-95 md:min-h-110">
      ...
      <div
        className="absolute inset-x-0 top-0 z-10 h-24 bg-linear-to-b from-black/40 to-transparent"
        aria-hidden
      />
      ...
      <div
        className="absolute inset-x-0 bottom-0 z-10 h-20 bg-linear-to-t from-black/30 to-transparent"
        aria-hidden
      />
      {/* Hero text - lower left */}
      <div className="relative z-20 mx-auto flex max-w-7xl items-end px-4 pb-10 pt-16 sm:px-6 sm:pb-14 sm:pt-20 md:min-h-110 md:pb-20 md:pt-28 lg:px-8">
